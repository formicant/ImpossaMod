...
keyTable: ; half-row   mask   name   index
        ...
        db 0,      %10000000, "ST"C  ; 41
        db 0,      %01000000, "JA"C  ; 42
        db 0,      %00100000, "JC"C  ; 43
        db 0,      %00010000, "FI"C  ; 44
        db 0,      %00001000, "UP"C  ; 45
        db 0,      %00000100, "DN"C  ; 46
        db 0,      %00000010, "LF"C  ; 47
        db 0,      %00000001, "RT"C  ; 48
